  ...
  \begin{enumerate}
    \item Let $\vec u=\mat{1\\2\\3}$, $\vec v=\mat{4\\5\\6}$, and $\vec w=\mat{7\\8\\9}$. Explain whether
      ...
      Make sure to include all relevant definitions.
        ...
        \begin{enumerate}
        \item A \emph{basis} for a subspace $V\subset \R^3$ is a linearly independent set of vectors $A$ such that $\Span\, A=V$.

        First, let's check whether $a$ is a libearly independent set.
